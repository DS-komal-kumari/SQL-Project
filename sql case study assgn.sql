CREATE DATABASE Assgn_CaseStudy
...
EmpJob_ID INT FOREIGN KEY REFERENCES Job(Job_ID),Manager_ID INT, Hire_Date DATE, Salary INT, Comm INT,	
...
SELECT E.*,D.DeptName FROM Employee AS E INNER JOIN Department AS D ON 
E.EmpDepartment_ID=D.Department_ID

--2. DISPLAY EMPLOYEES WITH THEIR DESIGNATIONS.
SELECT E.*,J.Designation FROM Employee AS E INNER JOIN Job AS J ON 
E.EmpJob_ID=J.Job_ID

--3. DISPLAY THE EMPLOYEES WITH THEIR DEPARTMENT NAMES AND REGIONAL GROUPS.
SELECT E.*,D.DeptName,L.City FROM Employee AS E 
INNER JOIN Department AS D ON E.EmpDepartment_ID=D.Department_ID
INNER JOIN Location AS L ON D.DepLocation_ID=L.Location_ID
